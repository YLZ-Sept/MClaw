...
const TABLE_CONFIGS = {
  ...
  purchase_orders: {
    ...
    columns: [
      ...
      { field: 'brand', header: '品牌', width: 12 },
      { field: 'category', header: '品类', width: 10 },
      { field: 'name', header: '名称', width: 25, required: true },
      { field: 'model', header: '型号', width: 12 },
      { field: 'quantity', header: '数量', width: 8 },
      { field: 'unit', header: '单位', width: 8 },
      { field: 'serial_number', header: '序列号', width: 18 },
      { field: 'unit_price', header: '单价', width: 10 },
      { field: 'total_price', header: '总价', width: 10 },
      { field: 'stock_date', header: '入库日期', width: 14 },
      { field: 'status', header: '状态', width: 10 },
      { field: 'created_at', header: '创建时间', width: 18, templateExclude: true },
    ],
  },
  ...
  sales_orders: {
    table: 'sales_orders',
    columns: [
      { field: 'customer_name', header: '客户', width: 15 },
      { field: 'distributor', header: '经销商', width: 15 },
      { field: 'product_name', header: '产品名称', width: 25, required: true },
      { field: 'model', header: '型号', width: 12 },
      { field: 'quantity', header: '数量', width: 8 },
      { field: 'unit', header: '单位', width: 8 },
      { field: 'serial_number', header: '序列号', width: 18 },
      { field: 'out_date', header: '出库日期', width: 14 },
      { field: 'unit_price', header: '单价', width: 10 },
      { field: 'total_price', header: '总价', width: 10 },
      { field: 'remark', header: '备注', width: 20 },
      { field: 'status', header: '状态', width: 10 },
  ...
  asset_ledger: {
    table: 'asset_ledger',
    columns: [
      { field: 'manufacturer', header: '厂商', width: 12 },
      { field: 'category', header: '类别', width: 10 },
      { field: 'product_name', header: '产品名称', width: 30, required: true },
      { field: 'model', header: '型号', width: 12 },
      { field: 'unit', header: '单位', width: 8 },
      { field: 'in_quantity', header: '入库数量', width: 10 },
      { field: 'out_quantity', header: '出库数量', width: 10 },
      { field: 'balance', header: '库存总数', width: 10 },
      { field: 'unit_price', header: '单价', width: 10 },
      { field: 'order_total', header: '合同订单总价', width: 14 },
      { field: 'inventory_value', header: '库存总价', width: 12 },
      { field: 'stock_date', header: '入库时间', width: 14 },
      { field: 'min_stock', header: '预警阈值', width: 10 },
      { field: 'created_at', header: '创建时间', width: 18, templateExclude: true },
    ],
  },
  ...
  returns: {
    table: 'returns',
    columns: [
      { field: 'order_type', header: '单据类型', width: 10 },
      { field: 'order_id', header: '关联单号', width: 25 },
      { field: 'product_name', header: '产品名称', width: 25, required: true },
      { field: 'model', header: '型号', width: 12 },
      { field: 'quantity', header: '数量', width: 8 },
      { field: 'reason', header: '原因', width: 25 },
      { field: 'type', header: '类型', width: 10 },
      { field: 'exchange_product', header: '换货产品', width: 20 },
      { field: 'status', header: '状态', width: 10 },
      { field: 'created_at', header: '创建时间', width: 18, templateExclude: true },
    ],
  },
  ...
  bid_statistics: {
    ...
    columns: [
      { field: 'bid_publish_time', header: '招标时间', width: 14 },
      { field: 'registration_time', header: '报名时间', width: 14 },
      { field: 'bid_time', header: '投标时间', width: 14 },
      { field: 'region', header: '区域', width: 10 },
      ...
      { field: 'project_content', header: '项目产品（服务）', width: 35 },
